...
urlpatterns = [
    ...
    path('profile_update',views.update_profile.as_view(),name='update_profile'),
    path('self_profile_delete', views.delete_self_account.as_view(), name='delete_self_profile'),
    ...
    path('delete_message/<int:sender_id>/', views.delete_message.as_view(), name='delete_message'),
    path('get_message/<int:sender_id>/', views.view_message.as_view(), name='get_message'),
    path('get_notification/', views.view_notifications.as_view(), name='get_notification'),
